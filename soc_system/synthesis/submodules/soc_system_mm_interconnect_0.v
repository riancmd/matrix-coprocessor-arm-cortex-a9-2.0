...
module soc_system_mm_interconnect_0 (
	...
	wire  [129:0] coprocessor_instruction_s1_agent_rf_source_data;                                    // coprocessor_instruction_s1_agent:rf_source_data -> coprocessor_instruction_s1_agent_rsp_fifo:in_data
	...
	wire  [129:0] coprocessor_instruction_s1_agent_rsp_fifo_out_data;                                 // coprocessor_instruction_s1_agent_rsp_fifo:out_data -> coprocessor_instruction_s1_agent:rf_sink_data
	...
	wire  [129:0] ready_signals_s1_agent_rf_source_data;                                              // ready_signals_s1_agent:rf_source_data -> ready_signals_s1_agent_rsp_fifo:in_data
	...
	wire  [129:0] ready_signals_s1_agent_rsp_fifo_out_data;                                           // ready_signals_s1_agent_rsp_fifo:out_data -> ready_signals_s1_agent:rf_sink_data
	...
	wire          coprocessor_instruction_s1_agent_rp_valid;                                          // coprocessor_instruction_s1_agent:rp_valid -> router_009:sink_valid
	wire  [128:0] coprocessor_instruction_s1_agent_rp_data;                                           // coprocessor_instruction_s1_agent:rp_data -> router_009:sink_data
	wire          coprocessor_instruction_s1_agent_rp_ready;                                          // router_009:sink_ready -> coprocessor_instruction_s1_agent:rp_ready
	wire          coprocessor_instruction_s1_agent_rp_startofpacket;                                  // coprocessor_instruction_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          coprocessor_instruction_s1_agent_rp_endofpacket;                                    // coprocessor_instruction_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire          ready_signals_s1_agent_rp_valid;                                                    // ready_signals_s1_agent:rp_valid -> router_011:sink_valid
	wire  [128:0] ready_signals_s1_agent_rp_data;                                                     // ready_signals_s1_agent:rp_data -> router_011:sink_data
	wire          ready_signals_s1_agent_rp_ready;                                                    // router_011:sink_ready -> ready_signals_s1_agent:rp_ready
	wire          ready_signals_s1_agent_rp_startofpacket;                                            // ready_signals_s1_agent:rp_startofpacket -> router_011:sink_startofpacket
	wire          ready_signals_s1_agent_rp_endofpacket;                                              // ready_signals_s1_agent:rp_endofpacket -> router_011:sink_endofpacket
	...
	wire          cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> coprocessor_instruction_s1_burst_adapter:sink0_valid
	wire  [128:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> coprocessor_instruction_s1_burst_adapter:sink0_data
	wire          cmd_mux_004_src_ready;                                                              // coprocessor_instruction_s1_burst_adapter:sink0_ready -> cmd_mux_004:src_ready
	wire    [6:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> coprocessor_instruction_s1_burst_adapter:sink0_channel
	wire          cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> coprocessor_instruction_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> coprocessor_instruction_s1_burst_adapter:sink0_endofpacket
	...
	wire  [128:0] coprocessor_instruction_s1_burst_adapter_source0_data;                              // coprocessor_instruction_s1_burst_adapter:source0_data -> coprocessor_instruction_s1_agent:cp_data
	...
	wire    [6:0] coprocessor_instruction_s1_burst_adapter_source0_channel;                           // coprocessor_instruction_s1_burst_adapter:source0_channel -> coprocessor_instruction_s1_agent:cp_channel
	...
	wire          cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> ready_signals_s1_burst_adapter:sink0_valid
	wire  [128:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> ready_signals_s1_burst_adapter:sink0_data
	wire          cmd_mux_006_src_ready;                                                              // ready_signals_s1_burst_adapter:sink0_ready -> cmd_mux_006:src_ready
	wire    [6:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> ready_signals_s1_burst_adapter:sink0_channel
	wire          cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> ready_signals_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> ready_signals_s1_burst_adapter:sink0_endofpacket
	...
	wire  [128:0] ready_signals_s1_burst_adapter_source0_data;                                        // ready_signals_s1_burst_adapter:source0_data -> ready_signals_s1_agent:cp_data
	...
	wire    [6:0] ready_signals_s1_burst_adapter_source0_channel;                                     // ready_signals_s1_burst_adapter:source0_channel -> ready_signals_s1_agent:cp_channel
	...
	wire          coprocessor_instruction_s1_agent_rdata_fifo_out_valid;                              // coprocessor_instruction_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_004:in_0_valid
	wire   [33:0] coprocessor_instruction_s1_agent_rdata_fifo_out_data;                               // coprocessor_instruction_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_004:in_0_data
	wire          coprocessor_instruction_s1_agent_rdata_fifo_out_ready;                              // avalon_st_adapter_004:in_0_ready -> coprocessor_instruction_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_004_out_0_valid;                                                  // avalon_st_adapter_004:out_0_valid -> coprocessor_instruction_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_004_out_0_data;                                                   // avalon_st_adapter_004:out_0_data -> coprocessor_instruction_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_004_out_0_ready;                                                  // coprocessor_instruction_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire    [0:0] avalon_st_adapter_004_out_0_error;                                                  // avalon_st_adapter_004:out_0_error -> coprocessor_instruction_s1_agent:rdata_fifo_sink_error
	...
	wire          ready_signals_s1_agent_rdata_fifo_out_valid;                                        // ready_signals_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] ready_signals_s1_agent_rdata_fifo_out_data;                                         // ready_signals_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_006:in_0_data
	wire          ready_signals_s1_agent_rdata_fifo_out_ready;                                        // avalon_st_adapter_006:in_0_ready -> ready_signals_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_006_out_0_valid;                                                  // avalon_st_adapter_006:out_0_valid -> ready_signals_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                                   // avalon_st_adapter_006:out_0_data -> ready_signals_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                                  // ready_signals_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                                  // avalon_st_adapter_006:out_0_error -> ready_signals_s1_agent:rdata_fifo_sink_error
